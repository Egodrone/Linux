...
// Router to create a handler for all routes
...
router.get("/", (req, res) => {
    ...
    res.write("Welcome the GomokuBoard server. This is the API of what can be done.\n\n" +
        ...
        " /place/       Place a random marker at the board.\n"
    );
    res.end();
});
...
router.get("/place", (req, res) => {
    var size = req.params.size;
    var x = placeRandom(0, gameBoard.getSize());
    var y = placeRandom(0, gameBoard.getSize());
